         	 ...
         	 <ol class="carousel-indicators text-center">
           	...
           	<div class="carousel-inner">
           	 	<div class="item active">
                        ...
                        <?php echo $this->Html->image('banner/p5.jpg', ['alt' => ''], ['class' => 'img-responsive']); ?>
           	 		</div>
                ...
                <div class="item">
                    <div class="overlay-slide">
                        <?php echo $this->Html->image('banner/p3.jpg', ['alt' => ''], ['class' => 'img-responsive']); ?>
           	 		</div>
           	 		<div class="carousel-caption">
               	 		<div class="col-md-12 col-xs-12 text-center">
                    <h2>Cyprass</h2>
           	 	...
           	 	<div class="item">
                    <div class="overlay-slide">
                        <?php echo $this->Html->image('banner/p10.jpg', ['alt' => ''], ['class' => 'img-responsive']); ?>
           	 		</div>
           	 		<div class="carousel-caption">
               	 		<div class="col-md-12 col-xs-12 text-center">
                    <h2>Cyprass</h2>
