    ...
    <div class="clearfix"></div>
              ...
              <ul class="portfolio-wrap" id="portfolio_items">
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio identity web-design">
                        <figure>
                            <?php echo $this->Html->image('portfolio/p1.jpg', ['alt' => '']); ?>
                            <figcaption>
                                <h5>Creative Zoe</h5>
                                <p class="links">
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio logo graphic">
                        <figure>
                        <?php echo $this->Html->image('portfolio/p2.jpg', ['alt' => '']); ?>
                            <figcaption>
                                <h5>Creative Zoe</h5>
                                <p class="links">
                                    <a href="portfolio-single.html"> <i class="fa fa-link"></i></a>
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio graphic logo">
                        <figure>
                            <?php echo $this->Html->image('portfolio/p3.jpg', ['alt' => '']); ?>
                            <figcaption>
                                <h5>Creative Zoe</h5>
                                <p class="links">
                                    <a href="portfolio-single.html"> <i class="fa fa-link"></i></a>
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio web-design identity">
                        <figure>
                            <?php echo $this->Html->image('portfolio/p7.jpg', ['alt' => '']); ?>
                            <figcaption>
                                <h5>Creative Zoe</h5>
                                <p class="links">
                                    <a href="portfolio-single.html"> <i class="fa fa-link"></i></a>
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio logo web-design">
                        <figure>
                            <?php echo $this->Html->image('portfolio/p5.jpg', ['alt' => '']); ?>
                            <figcaption>
                                <h5>Creative Zoe</h5>
                                <p class="links">
                                    <a href="portfolio-single.html"> <i class="fa fa-link"></i></a>
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio logo graphic">
                        <figure>
                            <?php echo $this->Html->image('portfolio/p6.jpg', ['alt' => '']); ?>
                            <figcaption>
                                <h5>Creative Zoe</h5>
                                <p class="links">
                                    <a href="portfolio-single.html"> <i class="fa fa-link"></i></a>
                    ...
                    <div class="tab-content main-tab-content">
                          <div role="tabpanel" class="tab-pane active " id="home">
                                <div class="col-md-12 col-sm-9">
                                     <?php echo $this->Html->image('about/web1.png', ['alt' => ''], ['class' => 'img-responsive']); ?>
                                </div>
                                <div class="col-md-12 col-sm-9">
                                    <div class="c-tab">
                          ...
                          <div role="tabpanel" class="tab-pane" id="profile">
                                <div class="col-md-12 col-sm-9">
                                     <?php echo $this->Html->image('about/browse.png', ['alt' => ''], ['class' => 'img-responsive']); ?>
                                </div>
                                <div class="col-md-12 col-sm-9">
                                    <div class="c-tab">
                          ...
                          <div role="tabpanel" class="tab-pane" id="photo">
                               <div class="col-md-12 col-sm-9">
                                   <?php echo $this->Html->image('about/graphics.png', ['alt' => ''], ['class' => 'img-responsive']); ?>
                                </div>
                               <div class="col-md-12 col-sm-9">
                                    <div class="c-tab">
        ...
        <div class="row">
            ...
            <div id="owl-demo" class="owl-carousel owl-theme team-items">
                <div class="item text-center">
                    <div class="single-member">
                        <div class="overlay-hover">
                            <?php echo $this->Html->image('team/pic6.jpg', ['alt' => ''], ['class' => 'img-responsive']); ?>
                ...
                <div class="item text-center">
                    <div class="single-member">
                        <div class="overlay-hover">
                            <?php echo $this->Html->image('team/pic1.jpg', ['alt' => ''], ['class' => 'img-responsive']); ?>
                            <div class="overlay-effect">
                                <ul class="social list-inline">
                                    <li><a href=""><i class="fa fa-facebook"></i></a></li>
                                    <li><a href=""><i class="fa fa-google-plus"></i></a></li>
                ...
                <div class="item text-center">
                    <div class="single-member">
                        <div class="overlay-hover">
                            <?php echo $this->Html->image('team/pic2.jpg', ['alt' => ''], ['class' => 'img-responsive']); ?>
                            <div class="overlay-effect">
                                <ul class="social list-inline">
                                    <li><a href=""><i class="fa fa-facebook"></i></a></li>
                                    <li><a href=""><i class="fa fa-google-plus"></i></a></li>
                ...
                <div class="item text-center">
                    <div class="single-member">
                        <div class="overlay-hover">
                            <?php echo $this->Html->image('team/pic5.jpg', ['alt' => ''], ['class' => 'img-responsive']); ?>
                            <div class="overlay-effect">
                                <ul class="social list-inline">
                                    <li><a href=""><i class="fa fa-facebook"></i></a></li>
                                    <li><a href=""><i class="fa fa-google-plus"></i></a></li>
                ...
                <div class="item text-center">
                    <div class="single-member">
                        <div class="overlay-hover">
                            <?php echo $this->Html->image('team/pic4.jpg', ['alt' => ''], ['class' => 'img-responsive']); ?>
                            <div class="overlay-effect">
                                <ul class="social list-inline">
                                    <li><a href=""><i class="fa fa-facebook"></i></a></li>
                                    <li><a href=""><i class="fa fa-google-plus"></i></a></li>
                ...
                <div id="owl-blog" class="owl-carousel owl-theme">
                        ...
                        <div class="single_blog">
                            <div class="post_img text-center">
                               <a href="blog-single.html">
                                   <?php echo $this->Html->image('blog/pic3.jpg', ['alt' => ''], ['class' => 'img-responsive']); ?>
                                </a>
                                <div class="post-date">
                                    <span>25</span> 6
                                </div>
                    ...
                    <div class="item ">
                        <div class="single_blog">
                            <div class="post_img text-center">
                                <a href="blog-single.html">
                                    <?php echo $this->Html->image('blog/pic4.jpg', ['alt' => ''], ['class' => 'img-responsive']); ?>
                                </a>
                                <div class="post-date">
                                    <span>25</span> 6
                                </div>
                    ...
                    <div class="item ">
                        <div class="single_blog">
                            <div class="post_img text-center">
                                <a href="blog-single.html">
                                    <?php echo $this->Html->image('blog/pic2.jpg', ['alt' => ''], ['class' => 'img-responsive']); ?>
                                </a>
                                <div class="post-date">
                                    <span>25</span> 6
                                </div>
                    ...
                    <div class="item ">
                        <div class="single_blog">
                            <div class="post_img text-center">
                                <a href="blog-single.html">
                                    <?php echo $this->Html->image('blog/pic5.jpg', ['alt' => ''], ['class' => 'img-responsive']); ?>
                                </a>
                                <div class="post-date">
                                    <span>25</span> 6
                                </div>
                    ...
                    <div class="item ">
                        <div class="single_blog">
                            <div class="post_img text-center">
                                <a href="blog-single.html">
                                    <?php echo $this->Html->image('blog/pic1.jpg', ['alt' => ''], ['class' => 'img-responsive']); ?>
                                </a>
                                <div class="post-date">
                                    <span>25</span> 6
                                </div>
                    ...
                    <div id="testimonial-carousel" class="owl-carousel owl-theme text-center testimonial-slide">
                        <div class="item">
                          <div class="testimonial-thumb">
                              <?php echo $this->Html->image('team/pic1.jpg', ['alt' => 'testimonial'], ['class' => 'img-circle']); ?>
                          </div>
                        ...
                        <div class="item">
                          <div class="testimonial-thumb">
                              <?php echo $this->Html->image('testimonial2.jpg', ['alt' => 'testimonial'], ['class' => 'img-circle']); ?>
                          </div>
                          <div class="testimonial-content">
                        ...
                        <div class="item">
                          <div class="testimonial-thumb">
                              <?php echo $this->Html->image('team/pic6.jpg', ['alt' => 'testimonial'], ['class' => 'img-circle']); ?>
                          </div>
                          <div class="testimonial-content">
        ...
        <div class="row wow fadeInLeft">
          <div id="client-carousel" class="col-sm-12 owl-carousel owl-theme text-center client-carousel">
            <div class="item client_logo">
              <a href="#">
                  <?php echo $this->Html->image('clients/client1.png', ['alt' => 'client'], ['class' => 'img-responsive']); ?>
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                  <?php echo $this->Html->image('clients/client2.png', ['alt' => 'client'], ['class' => 'img-responsive']); ?>
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                  <?php echo $this->Html->image('clients/client3.png', ['alt' => 'client'], ['class' => 'img-responsive']); ?>
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                  <?php echo $this->Html->image('clients/client4.png', ['alt' => 'client'], ['class' => 'img-responsive']); ?>
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                  <?php echo $this->Html->image('clients/client5.png', ['alt' => 'client'], ['class' => 'img-responsive']); ?>
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                  <?php echo $this->Html->image('clients/client6.png', ['alt' => 'client'], ['class' => 'img-responsive']); ?>
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                  <?php echo $this->Html->image('clients/client7.png', ['alt' => 'client'], ['class' => 'img-responsive']); ?>
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
                  <?php echo $this->Html->image('clients/client8.png', ['alt' => 'client'], ['class' => 'img-responsive']); ?>
              </a>
            </div>
