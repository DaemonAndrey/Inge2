...
public class TelefonoConLetras {
  ...
  @Test
  public void testTelefonoConLetras() throws Exception {
    ...
    driver.findElement(By.id("telephone-number")).sendKeys("+abc 87878787");
    ...
    try {
      assertEquals("Debe contener solamente números.", driver.findElement(By.cssSelector("div.error-message")).getText());
    } catch (Error e) {
