...
public class CorreoNoInstitucional {
  ...
  @Test
  public void testCorreoNoInstitucional() throws Exception {
    driver.get(baseUrl + "/protea/src/protea_reservations/pages/home");
    driver.findElement(By.linkText("Registrar")).click();
    driver.findElement(By.id("username")).clear();
    driver.findElement(By.id("username")).sendKeys("alberto.bolanoscastro@gmail.com");
