...
public class TelefonoMasDe16Numeros {
  ...
  @Test
  public void testTelefonoMasDe16Numeros() throws Exception {
    ...
    driver.findElement(By.id("telephone-number")).sendKeys("+1 949 27 15 92 38");
