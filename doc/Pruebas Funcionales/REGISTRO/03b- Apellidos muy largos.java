...
public class ApellidosMuyLargos {
  ...
  @Test
  public void testApellidosMuyLargos() throws Exception {
    ...
    driver.findElement(By.id("first-name")).sendKeys("Alberto");
    driver.findElement(By.id("last-name")).clear();
    driver.findElement(By.id("last-name")).sendKeys("de la O de Montes de Oca");
    driver.findElement(By.id("last-name")).clear();
    driver.findElement(By.id("last-name")).sendKeys("de la Espriella de Montes de Oca");
    driver.findElement(By.id("telephone-number")).clear();
    driver.findElement(By.id("telephone-number")).sendKeys("87878787");
    driver.findElement(By.id("password")).clear();
    driver.findElement(By.id("password")).sendKeys("alberto87");
    driver.findElement(By.id("repass")).clear();
    driver.findElement(By.id("repass")).sendKeys("alberto87");
    driver.findElement(By.id("department")).clear();
    driver.findElement(By.id("department")).sendKeys("Escuela de Educación");
    driver.findElement(By.cssSelector("button.btn.btn-success")).click();
    try {
      assertEquals("Solo se permiten 30 caracteres.", driver.findElement(By.cssSelector("div.error-message")).getText());
    } catch (Error e) {
