...
public class ContrasenaMenosDe8Caracteres {
  ...
  @Test
  public void testContrasenaMenosDe8Caracteres() throws Exception {
    ...
    driver.findElement(By.id("password")).sendKeys("abc87");
    driver.findElement(By.id("repass")).clear();
    driver.findElement(By.id("repass")).sendKeys("abc87");
