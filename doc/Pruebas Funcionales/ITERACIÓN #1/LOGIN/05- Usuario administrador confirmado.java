...
public class UsuarioAdministradorConfirmado {
  ...
  @Test
  public void testUsuarioAdministradorConfirmado() throws Exception {
    ...
    try {
      assertEquals("Administrar", driver.findElement(By.linkText("Administrar")).getText());
    } catch (Error e) {
