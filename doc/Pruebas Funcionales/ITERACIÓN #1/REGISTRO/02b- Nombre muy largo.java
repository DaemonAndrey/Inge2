...
public class NombreMuyLargo {
  ...
  @Test
  public void testNombreMuyLargo() throws Exception {
    ...
    driver.findElement(By.id("first-name")).sendKeys("Alberto Jose de la Trinidad");
    ...
    try {
      assertEquals("Solo se permiten 20 caracteres.", driver.findElement(By.cssSelector("div.error-message")).getText());
    } catch (Error e) {
