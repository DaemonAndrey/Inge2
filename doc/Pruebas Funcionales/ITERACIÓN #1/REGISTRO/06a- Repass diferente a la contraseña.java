...
public class RepassDiferenteAContrasena {
  ...
  @Test
  public void testRepassDiferenteAContrasena() throws Exception {
    ...
    driver.findElement(By.id("repass")).sendKeys("alberto8787");
    driver.findElement(By.id("department")).clear();
    driver.findElement(By.id("department")).sendKeys("Escuela de Educación");
    driver.findElement(By.cssSelector("button.btn.btn-success")).click();
    try {
      assertEquals("Las contraseñas no coinciden.", driver.findElement(By.cssSelector("div.error-message")).getText());
    } catch (Error e) {
