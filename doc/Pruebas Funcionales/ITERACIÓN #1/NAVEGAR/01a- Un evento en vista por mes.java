...
public class UnEventoMes {
  ...
  @Test
  public void testUnEventoMes() throws Exception {
    ...
    try {
      assertEquals("Televisor LG abc - YD-5950", driver.findElement(By.cssSelector("span.fc-title")).getText());
    } catch (Error e) {
