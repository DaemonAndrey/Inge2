...
public class 44TelFonoConMenosDe8DGitos {
  ...
  @Test
  public void test44TelFonoConMenosDe8DGitos() throws Exception {
    ...
    driver.findElement(By.id("users-telephone-number")).sendKeys("1111");
    driver.findElement(By.cssSelector("button.btn.btn-info")).click();
    try {
