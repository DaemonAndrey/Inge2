...
public class 15ApellidoConNumeros {
  ...
  @Test
  public void test15ApellidoConNumeros() throws Exception {
    ...
    driver.findElement(By.id("first-name")).sendKeys("Al");
    ...
    new Select(driver.findElement(By.id("role-id"))).selectByVisibleText("SuperAdministrador");
    driver.findElement(By.cssSelector("button.btn.btn-info")).click();
    try {
