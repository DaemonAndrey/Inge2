...
public class 14NombreConNMeros {
  ...
  @Test
  public void test14NombreConNMeros() throws Exception {
    ...
    driver.findElement(By.id("first-name")).sendKeys("123456");
    ...
    driver.findElement(By.id("username")).clear();
    driver.findElement(By.id("username")).sendKeys("luis.einstein@ucr.ac.cr");
    driver.findElement(By.id("telephone-number")).clear();
    driver.findElement(By.id("telephone-number")).sendKeys("86868686");
    driver.findElement(By.cssSelector("button.btn.btn-info")).click();
    try {
