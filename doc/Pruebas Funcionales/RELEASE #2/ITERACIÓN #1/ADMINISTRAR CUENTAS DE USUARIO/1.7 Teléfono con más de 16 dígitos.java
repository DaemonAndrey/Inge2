...
public class 17TelFonoConMSDe16DGitos {
  ...
  @Test
  public void test17TelFonoConMSDe16DGitos() throws Exception {
    ...
    driver.findElement(By.id("telephone-number")).sendKeys("89898989898989898989");
    driver.findElement(By.cssSelector("button.btn.btn-info")).click();
    try {
