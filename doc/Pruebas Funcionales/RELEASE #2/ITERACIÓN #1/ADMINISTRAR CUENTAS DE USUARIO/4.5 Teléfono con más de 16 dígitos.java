...
public class 45TelFonoConMSDe16DGitos {
  ...
  @Test
  public void test45TelFonoConMSDe16DGitos() throws Exception {
    ...
    driver.findElement(By.id("users-telephone-number")).sendKeys("89898989111122223333");
    driver.findElement(By.cssSelector("button.btn.btn-info")).click();
    try {
