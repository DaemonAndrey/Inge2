...
public class 41EditarMiCuentaExitosamente {
  ...
  @Test
  public void test41EditarMiCuentaExitosamente() throws Exception {
    ...
    driver.findElement(By.id("users-last-name")).sendKeys("Vargas Marin");
    driver.findElement(By.cssSelector("button.btn.btn-info")).click();
    try {
