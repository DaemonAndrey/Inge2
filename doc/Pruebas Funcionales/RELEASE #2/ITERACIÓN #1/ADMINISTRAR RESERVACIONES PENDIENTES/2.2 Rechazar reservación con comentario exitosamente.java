...
public class 22RechazarReservaciNConComentarioExitosamente {
  ...
  @Test
  public void test22RechazarReservaciNConComentarioExitosamente() throws Exception {
    ...
    driver.findElement(By.id("reservations-admin-comment")).sendKeys("Se rechaza su reservación");
    driver.findElement(By.id("reservations-admin-comment")).clear();
    driver.findElement(By.id("reservations-admin-comment")).sendKeys("Se rechaza su reservación.");
    driver.findElement(By.xpath("(//input[@name='accion'])[2]")).click();
    assertEquals("La reservación fue rechazada exitosamente", driver.findElement(By.cssSelector("div.message")).getText());
