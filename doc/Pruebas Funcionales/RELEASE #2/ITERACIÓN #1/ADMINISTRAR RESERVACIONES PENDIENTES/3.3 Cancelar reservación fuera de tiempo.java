...
public class 33CancelarReservaciNFueraDeTiempo {
  ...
  @Test
  public void test33CancelarReservaciNFueraDeTiempo() throws Exception {
    ...
    try {
      assertEquals("14/Jun/2016", driver.findElement(By.cssSelector("td")).getText());
    } catch (Error e) {
    ...
    try {
      assertEquals("Esta reservación ya no se puede cancelar, lo sentimos.", driver.findElement(By.cssSelector("div.message")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
