...
public class 22ActualizarDAsEnNegativo {
  ...
  @Test
  public void test22ActualizarDAsEnNegativo() throws Exception {
    ...
    for (int second = 0;; second++) {
    	...
    	try { if ("La cantidad debe ser mayor o igual a 0".equals(driver.findElement(By.cssSelector("div.error-message")).getText())) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }
