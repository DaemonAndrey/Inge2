...
public class 21ReservarComoAdministrador {
  ...
  @Test
  public void test21ReservarComoAdministrador() throws Exception {
    ...
    driver.findElement(By.linkText("Ver Reservas")).click();
    new Select(driver.findElement(By.id("start"))).selectByVisibleText("08:00:00");
    new Select(driver.findElement(By.id("end"))).selectByVisibleText("11:00:00");
    new Select(driver.findElement(By.id("resource_type"))).selectByVisibleText("Sala");
    new Select(driver.findElement(By.id("resource"))).selectByVisibleText("Laboratorio de Cómputo");
    driver.findElement(By.id("course_id")).clear();
    driver.findElement(By.id("course_id")).sendKeys("WH-3536");
    driver.findElement(By.id("course_name")).clear();
    driver.findElement(By.id("course_name")).sendKeys("Inducción");
    driver.findElement(By.cssSelector("button.btn.btn-info")).click();
    driver.findElement(By.id("comment")).clear();
    driver.findElement(By.id("comment")).sendKeys("Necesito 1 laptop.");
