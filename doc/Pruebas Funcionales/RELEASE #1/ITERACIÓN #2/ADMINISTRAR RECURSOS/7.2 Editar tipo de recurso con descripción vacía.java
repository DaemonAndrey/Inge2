...
public class 72EditarTipoDeRecursoConDescripciNVacA {
  ...
  @Test
  public void test72EditarTipoDeRecursoConDescripciNVacA() throws Exception {
    ...
    driver.findElement(By.xpath("//tr[4]/td[2]/a/i")).click();
    driver.findElement(By.id("resourcetypes-description")).clear();
    driver.findElement(By.id("resourcetypes-description")).sendKeys("");
    driver.findElement(By.cssSelector("button.btn.btn-success")).click();
    try {
      assertEquals("", driver.findElement(By.id("resourcetypes-description")).getText());
    } catch (Error e) {
