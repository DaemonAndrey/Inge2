...
public class 15AgregarRecursoConCDigoRepetido {
  ...
  @Test
  public void test15AgregarRecursoConCDigoRepetido() throws Exception {
    ...
    driver.findElement(By.id("resources-resource-name")).sendKeys("nombre Sala");
    driver.findElement(By.id("resources-resource-code")).clear();
    driver.findElement(By.id("resources-resource-code")).sendKeys("ABC");
    ...
    try {
      assertEquals("Esta placa/serie ya existe", driver.findElement(By.cssSelector("div.error-message")).getText());
    } catch (Error e) {
