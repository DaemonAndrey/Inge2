...
public class 71EditarTipoDeRecursoExitosamente {
  ...
  @Test
  public void test71EditarTipoDeRecursoExitosamente() throws Exception {
    ...
    driver.findElement(By.id("resourcetypes-description")).sendKeys("Salas");
