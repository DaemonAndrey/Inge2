...
public class 51DesasociarAdministradoresExitosamente {
  ...
  @Test
  public void test51DesasociarAdministradoresExitosamente() throws Exception {
    ...
    try {
      assertEquals("Se ha desasociado el administrador del recurso", driver.findElement(By.cssSelector("div.message.success")).getText());
    } catch (Error e) {
