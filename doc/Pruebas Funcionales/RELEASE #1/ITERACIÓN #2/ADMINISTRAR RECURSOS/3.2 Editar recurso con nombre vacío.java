...
public class 32EditarRecursoConNombreVacO {
  ...
  @Test
  public void test32EditarRecursoConNombreVacO() throws Exception {
    ...
    driver.findElement(By.id("resources-resource-name")).sendKeys("");
