...
public class 34EditarRecursoConCDigoVacO {
  ...
  @Test
  public void test34EditarRecursoConCDigoVacO() throws Exception {
    ...
    driver.findElement(By.id("resources-resource-code")).sendKeys("");
