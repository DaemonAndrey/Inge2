...
public class 12AgregarRecursoConNombreVacO {
  ...
  @Test
  public void test12AgregarRecursoConNombreVacO() throws Exception {
    ...
    driver.findElement(By.id("resources-description")).sendKeys("Descripción de la sala");
    driver.findElement(By.cssSelector("button.btn.btn-success")).click();
    try {
      assertEquals("", driver.findElement(By.id("resources-resource-name")).getText());
    } catch (Error e) {
