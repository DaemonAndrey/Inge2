...
public class 13AgregarRecursoConNombreNoVLido {
  ...
  @Test
  public void test13AgregarRecursoConNombreNoVLido() throws Exception {
    ...
    driver.findElement(By.id("resources-resource-name")).sendKeys("Sala nombre ;");
    driver.findElement(By.id("resources-resource-code")).clear();
    driver.findElement(By.id("resources-resource-code")).sendKeys("placaSerie");
    driver.findElement(By.id("resources-description")).clear();
    driver.findElement(By.id("resources-description")).sendKeys("Descripción");
    driver.findElement(By.cssSelector("button.btn.btn-success")).click();
    try {
      assertEquals("Sólo se permiten caracteres alfanuméricos", driver.findElement(By.cssSelector("div.error-message")).getText());
    } catch (Error e) {
