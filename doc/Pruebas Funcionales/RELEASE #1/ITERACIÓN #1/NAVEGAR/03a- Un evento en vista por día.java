...
public class UnEventoDia {
  ...
  @Test
  public void testUnEventoDia() throws Exception {
    ...
    driver.findElement(By.xpath("(//button[@type='button'])[3]")).click();
    try {
      assertEquals("Televisor LG abc - YD-5950", driver.findElement(By.cssSelector("div.fc-title")).getText());
    } catch (Error e) {
