...
public class 41AsociarAdministradoresExitosamente {
  ...
  @Test
  public void test41AsociarAdministradoresExitosamente() throws Exception {
    ...
    try {
      assertEquals("Se ha asociado el administrador con el recurso", driver.findElement(By.cssSelector("div.message.success")).getText());
    } catch (Error e) {
