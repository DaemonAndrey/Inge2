...
public class 33EditarRecursoConNombreNoVLido {
  ...
  @Test
  public void test33EditarRecursoConNombreNoVLido() throws Exception {
    ...
    for (int second = 0;; second++) {
    	...
    	try { if ("Sólo se permiten caracteres alfanuméricos".equals(driver.findElement(By.cssSelector("div.error-message")).getText())) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }
