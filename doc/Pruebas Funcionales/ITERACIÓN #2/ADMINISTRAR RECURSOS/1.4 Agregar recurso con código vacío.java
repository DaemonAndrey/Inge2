...
public class 14AgregarRecursoConCDigoVacO {
  ...
  @Test
  public void test14AgregarRecursoConCDigoVacO() throws Exception {
    ...
    try {
      assertEquals("", driver.findElement(By.id("resources-resource-code")).getText());
    } catch (Error e) {
