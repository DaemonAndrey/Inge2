...
public class 61AgregarTipoDeRecursoExitosamente {
  ...
  @Test
  public void test61AgregarTipoDeRecursoExitosamente() throws Exception {
    ...
    driver.findElement(By.id("resourcetypes-description")).sendKeys("Computadora");
