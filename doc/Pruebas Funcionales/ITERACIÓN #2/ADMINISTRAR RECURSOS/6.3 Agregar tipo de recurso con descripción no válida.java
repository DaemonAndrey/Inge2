...
public class 63AgregarTipoDeRecursoConDescripciNNoVLida {
  ...
  @Test
  public void test63AgregarTipoDeRecursoConDescripciNNoVLida() throws Exception {
    ...
    driver.findElement(By.id("resourcetypes-description")).sendKeys("Recurso Nuevo ;");
