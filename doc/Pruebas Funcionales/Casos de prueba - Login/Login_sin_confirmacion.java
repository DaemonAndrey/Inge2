...
public class LoginDeUsuarioNoConfirmado {
  ...
  @Test
  public void testLoginDeUsuarioNoConfirmado() throws Exception {
    ...
    try {
      assertEquals("Su solicitud de registro todavía no ha sido procesada, por favor espere.", driver.findElement(By.cssSelector("div.message.error")).getText());
    } catch (Error e) {
