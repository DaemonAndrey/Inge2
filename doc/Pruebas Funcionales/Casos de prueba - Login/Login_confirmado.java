...
public class LoginDeUsuarioConfirmado {
  ...
  @Test
  public void testLoginDeUsuarioConfirmado() throws Exception {
    ...
    try {
      assertEquals("docente@ucr.ac.cr", driver.findElement(By.linkText("docente@ucr.ac.cr")).getText());
    } catch (Error e) {
