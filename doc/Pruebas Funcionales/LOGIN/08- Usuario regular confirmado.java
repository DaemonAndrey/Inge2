...
public class UsuarioRegularConfirmado {
  ...
  @Test
  public void testUsuarioRegularConfirmado() throws Exception {
    ...
    try {
      assertEquals("Reservar", driver.findElement(By.linkText("Reservar")).getText());
    } catch (Error e) {
