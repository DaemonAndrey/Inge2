...
public class UsuarioRegularSinConfirmar {
  ...
  @Test
  public void testUsuarioRegularSinConfirmar() throws Exception {
    ...
    try {
      assertEquals("Su registro aún no ha sido procesado, por favor espere", driver.findElement(By.cssSelector("div.message.error")).getText());
    } catch (Error e) {
