...
public class RegistroTelefonoInvalido {
  ...
  @Test
  public void testRegistroTelefonoInvalido() throws Exception {
    ...
    driver.findElement(By.id("telephone-number")).sendKeys("2224466");
    driver.findElement(By.cssSelector("button.btn.btn-success")).click();
    try {
      assertEquals("Debe contener al menos 8 dígitos", driver.findElement(By.cssSelector("div.error-message")).getText());
    } catch (Error e) {
