...
public class 31AgregarUsuarioExitosamente {
  ...
  @Test
  public void test31AgregarUsuarioExitosamente() throws Exception {
    ...
    driver.findElement(By.id("username")).clear();
    driver.findElement(By.id("username")).sendKeys("alvaro.campos@ucr.ac.cr");
    driver.findElement(By.id("telephone-number")).clear();
    driver.findElement(By.id("telephone-number")).sendKeys("89898989");
    new Select(driver.findElement(By.id("department"))).selectByVisibleText("Escuela Educación Física y Deportes");
    new Select(driver.findElement(By.id("position"))).selectByVisibleText("Docente");
    driver.findElement(By.cssSelector("button.btn.btn-info")).click();
    driver.findElement(By.linkText("Nombre")).click();
    try {
      assertEquals("Alvaro Campos", driver.findElement(By.xpath("//tr[4]/td[2]")).getText());
    } catch (Error e) {
