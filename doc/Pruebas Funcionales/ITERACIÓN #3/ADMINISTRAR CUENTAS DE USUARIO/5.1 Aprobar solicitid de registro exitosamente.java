...
public class 51AprobarSolicitidDeRegistroExitosamente {
  ...
  @Test
  public void test51AprobarSolicitidDeRegistroExitosamente() throws Exception {
    ...
    driver.findElement(By.xpath("//tr[7]/td[5]/a/i")).click();
    driver.findElement(By.cssSelector("span.btn.btn-info")).click();
    try {
      assertEquals("Se ha aceptado la solicitud con éxito.", driver.findElement(By.xpath("(//div[@onclick=\"this.classList.add('hidden')\"])[2]")).getText());
    } catch (Error e) {
