...
public class 13CorreoRepetido {
  ...
  @Test
  public void test13CorreoRepetido() throws Exception {
    ...
    driver.findElement(By.id("last-name")).sendKeys("Campos Monge");
    driver.findElement(By.id("password")).clear();
    ...
    driver.findElement(By.id("telephone-number")).sendKeys("84848484");
    driver.findElement(By.cssSelector("button.btn.btn-info")).click();
    try {
      assertEquals("Este correo ya está registrado.", driver.findElement(By.cssSelector("div.error-message")).getText());
    } catch (Error e) {
